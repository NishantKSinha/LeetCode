<h2> 143 24
3076. Shortest Uncommon Substring in an Array</h2><hr><div><p>You are given an array <code>arr</code> of size <code>n</code> consisting of <strong>non-empty</strong> strings.</p>
